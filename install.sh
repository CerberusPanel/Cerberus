...
print_logo () {
	...
	echo "              @@@@@@@@@@@@@@@@@@@@@                      @                      @@@@@@@@@@@@@             "
	echo
	echo "                         CCCCCC   EEEEEEE   RRRRRR   BBBBBB   EEEEEEE   RRRRRR   U   U   SSSSSSS         "
	echo "                        CC        E        R    R   B    B   E        R    R   U   U  S              "
	echo "                        CC        EEEE     RRRRRR   BBBBBB   EEEE     RRRRRR   U   U   SSSSS         "
	echo "                        CC        E        R   R    B    B   E        R   R    U   U       S       "
	echo "                         CCCCCC   EEEEEEE  R    R   BBBBBB   EEEEEEE  R    R    UUU     SSSSSSS    "
	echo
	echo
}
